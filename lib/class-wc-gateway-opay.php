...
class WC_Gateway_Opay_DCA extends WC_Payment_Gateway
{
    ...
    public function save_dca_details()
    {
        ...
        if ( isset( $_POST['periodType'] ) ) {
            ...
            $periodTypes = array_map( 'wc_clean', sanitize_text_field($_POST['periodType']) );
            $frequencys  = array_map( 'wc_clean', sanitize_text_field($_POST['frequency'] ) );
            $execTimes   = array_map( 'wc_clean', sanitize_text_field($_POST['execTimes'] ) );
